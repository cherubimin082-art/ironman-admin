      ...
      <div style={{ ...styles.leftPanel, display: isCompact ? "none" : "flex" }}>
        ...
        <div style={styles.leftContent}>
          ...
          <div style={styles.heroBlock}>
            ...
            <p style={styles.heroSub}>One unified dashboard for vendors, delivery teams, and administrators — built for speed and scale.</p>
          </div>
...
const styles = {
  ...
  footerNote: { textAlign: "center", fontSize: 11.5, color: "#94a3b8", fontWeight: 500, margin: 0 },
};
